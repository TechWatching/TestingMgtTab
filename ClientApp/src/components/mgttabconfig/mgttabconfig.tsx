 ...
 */
class MgtTabConfig extends React.Component {
    render() {
        /**
         ...
         */
        microsoftTeams.settings.setSettings({ entityId: "grayIconTab", contentUrl: window.location.origin + "/tab" });
